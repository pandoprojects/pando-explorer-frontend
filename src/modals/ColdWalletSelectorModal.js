...
export class ColdWalletAddressRow extends React.Component {
    ...
    async fetchBalances(address){
        let response = await Api.fetchWallet(address, {network: Pando.getChainID()});
            ...
            balanceView = (
                <React.Fragment>
                    <div className="ColdWalletSelectorModal__amount-container">
                        <div className="ColdWalletSelectorModal__amount">{balances.pando}</div>
                        <img className="ColdWalletSelectorModal__amount-icon"
                             src="/img/tokens/pando_large@2x.png"
                        />
                    </div>
                    <div className="ColdWalletSelectorModal__amount-container">
                        <div className="ColdWalletSelectorModal__amount">{balances.ptx}</div>
                        <img className="ColdWalletSelectorModal__amount-icon"
