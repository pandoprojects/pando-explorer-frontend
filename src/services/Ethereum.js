...
export default class Ethereum {
    ...
    static unsignedTransaction(txData) {
        ...
        if (tokenType === TokenTypes.ERC20_PANDO) {
            let data = pandoContract.methods.transfer(to, amountWei).encodeABI();

            return {
                from: from,
                to: pandoContractAddress,
                data: data,
                gas: gas,
