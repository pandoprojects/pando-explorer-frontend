...
export default class Wallet {
    ...
    static _unlockStrategy = null;
    static _unlockKey = null;
    ...
    static setUnlockStrategy(unlockStrategy) {
        this._unlockStrategy = unlockStrategy
    }
    static getUnlockStrategy() {
        return this._unlockStrategy
    }
    static setUnlockKey(key) {
        this._unlockKey = key
    }
    static getUnlockKey() {
        return this._unlockKey
    }
    ...
    static async walletFromTrezor(page) {
        ...
        TrezorConnect.manifest({
            email: 'support@pandoproject.org',
            appUrl: 'https://wallet.pando.org',
            keepSession: true
        });
    ...
    static async getPandoTxSequence(address, network) {
    ...
    static async signTransaction(network, unsignedTx, password) {
        ...
        if (hardware === "trezor") {
            ...
            if (wallet) {
                ...
                return Pando.signTransaction(unsignedTx, wallet.privateKey);
            }
            else {
